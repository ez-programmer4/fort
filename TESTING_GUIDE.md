...
about whether the *system* behaves correctly.
...
| **Sales** | dashboard.view, alerts.view, products.view, inventory.view, sales.view, sales.dispense |
...
| # | Scenario | Steps | Expected |
|---|---|---|---|
| 10.1 ✅ | Dispense — single item | Sales → New Dispense, pick location, product → batch, quantity, (optional per-line price override), submit | Order created (`DSP-00001`), stock decreases at that location/batch |
| 10.2 ✅ | Dispense — multiple items | Add several product/batch/qty lines before confirming | All lines processed atomically; one order, multiple `DispenseItem`s |
