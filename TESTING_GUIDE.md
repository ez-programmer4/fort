...
| #        | Scenario                     | Steps                                                                                                      | Expected                                                                                                                  |
| -------- | ---------------------------- | ---------------------------------------------------------------------------------------------------------- | ------------------------------------------------------------------------------------------------------------------------- |
| 10.1 ✅  | Dispense — single item       | Sales → New Dispense, pick location, click "+ Add product", then use the search-combo (type a name/code/batch) and select a result | Combo appears in place of the button, auto-focused; item added to the cart instantly; quantity/price editable in Step 2, submit creates the order (`DSP-00001`), stock decreases at that location/batch |
| 10.2 ✅  | Dispense — multiple items    | After the first add, the combo stays open — search and select again to add more without re-clicking the button | All lines processed atomically; one order, multiple `DispenseItem`s                                                       |
...
| 10.1d ✅ | Add-product combo — collapse | Click the "×" next to the combo, or switch location                                                        | Combo collapses back to the "+ Add product" button; switching location also clears the cart                              |
